        ...
        <section className="hero page-hero section ulrich-hero">
          <div className="container hero-grid">
            <div className="hero-copy reveal">
              ...
              <p className="lead">
                O foco está em conduzir a energia com elegança, groove, presença e assinatura.
              </p>
        ...
        <section className="section alt">
          <div className="container reveal">
            ...
            <div className="approach-grid">
              ...
              <article className="info-card">
                <h3>Pressão</h3>
                <p>A intensidade sobe com intenção, sem perder groove, elegança e coerência estética.</p>
              </article>
        ...
        <section className="section">
          <div className="container reveal">
            ...
            <p className="section-text section-text--highlight">
              O projeto existe para controlar a pista com elegança e fazer a música ser sentida de verdade.
            </p>
          </div>
        </section>
          ...
          <div className="container reveal">
            ...
            <div className="presskit-points">
              ...
              <article className="info-card">
                ...
                <p>Projeto guiado por elegança, leitura de momento e assinatura própria.</p>
              </article>
